...
namespace QuickFrame.Data.Configuration {
...
#if TESTING
		private Dictionary<string, string> _connectionStringList = new Dictionary<string, string> {
			{"DefaultConnection", "Data Source=DEACSQLDEV001;Initial Catalog=Asmt;Integrated Security=True;MultipleActiveResultSets=True" },
			{"Security", "Data Source=DEACSQLDEV001;Initial Catalog=Asmt;Integrated Security=True;MultipleActiveResultSets=True" },
			{"AdSecurity", "LDAP://DC=DEAC,DC=PAD,DC=LOCAL" },
			{"DocumentsConnection", "Data Source=DEACSQLDEV001;Initial Catalog=ControlledDocs;Integrated Security=True;MultipleActiveResultSets=true" }
		};
#else
		private Dictionary<string, string> _connectionStringList = new Dictionary<string, string>();
#endif
